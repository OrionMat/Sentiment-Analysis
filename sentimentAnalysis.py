...
plt.plot(np.arange(1, len(BBC_busin_article_sentiments)+1), BBC_busin_article_sentiments, 'r.')
plt.plot(np.arange(1, len(BBC_enter_article_sentiments)+1), BBC_enter_article_sentiments, 'g.')
plt.plot(np.arange(1, len(BBC_polit_article_sentiments)+1), BBC_polit_article_sentiments, 'b.')
plt.plot(np.arange(1, len(BBC_sport_article_sentiments)+1), BBC_sport_article_sentiments, 'y.')
plt.plot(np.arange(1, len(BBC_techn_article_sentiments)+1), BBC_techn_article_sentiments, 'm.')
...
plt.hist(BBC_busin_article_sentiments, bins=bin_num, color='r', alpha=0.7, rwidth=0.85, label='busin')
plt.hist(BBC_enter_article_sentiments, bins=bin_num, color='g', alpha=0.7, rwidth=0.85, label='enter')
plt.hist(BBC_polit_article_sentiments, bins=bin_num, color='b', alpha=0.7, rwidth=0.85, label='polit')
plt.hist(BBC_sport_article_sentiments, bins=bin_num, color='y', alpha=0.7, rwidth=0.85, label='sport')
plt.hist(BBC_techn_article_sentiments, bins=bin_num, color='m', alpha=0.7, rwidth=0.85, label='techn')
plt.grid(axis='y', alpha=0.75)
plt.xlabel('Sentiment intencity')
plt.ylabel('Frequency')
plt.legend(loc='upper right')
plt.title('BBC articles')
plt.savefig("C:\\Users\\Orion\\Documents\\GitHub\\Sentiment-Analysis\\figures\\BBC_hist.eps", dpi=1000, format='eps')

#plt.figure("BBC KDE: Fact vs. polit")
df_news_busin = pandas.DataFrame({'busin': BBC_busin_article_sentiments})
df_news_enter = pandas.DataFrame({'enter': BBC_enter_article_sentiments})
df_news_polit = pandas.DataFrame({'polit': BBC_polit_article_sentiments})
df_news_sport = pandas.DataFrame({'sport': BBC_sport_article_sentiments})
df_news_techn = pandas.DataFrame({'techn': BBC_techn_article_sentiments})
df_news = pandas.concat([df_news_busin, df_news_enter, df_news_polit, df_news_sport, df_news_techn], axis=1)
df_news.plot.kde(title='BBC KDE (articles)')
plt.xlabel('Sentiment intencity')
plt.ylabel('Probability')
...
plt.hist(BBC_busin_flat_list, bins=bin_num, color='r', alpha=0.7, rwidth=0.85, label='busin')
plt.hist(BBC_enter_flat_list, bins=bin_num, color='g', alpha=0.7, rwidth=0.85, label='enter')
plt.hist(BBC_polit_flat_list, bins=bin_num, color='b', alpha=0.7, rwidth=0.85, label='polit')
plt.hist(BBC_sport_flat_list, bins=bin_num, color='y', alpha=0.7, rwidth=0.85, label='sport')
plt.hist(BBC_techn_flat_list, bins=bin_num, color='m', alpha=0.7, rwidth=0.85, label='techn')
plt.grid(axis='y', alpha=0.75)
plt.xlabel('Sentiment intencity')
plt.ylabel('Frequency')
plt.legend(loc='upper right')
...
df_news_busin = pandas.DataFrame({'busin': BBC_busin_flat_list})
df_news_enter = pandas.DataFrame({'enter': BBC_enter_flat_list})
df_news_polit = pandas.DataFrame({'polit': BBC_polit_flat_list})
df_news_sport = pandas.DataFrame({'sport': BBC_sport_flat_list})
df_news_techn = pandas.DataFrame({'techn': BBC_techn_flat_list})
df_news = pandas.concat([df_news_busin, df_news_enter, df_news_polit, df_news_sport, df_news_techn], axis=1)
